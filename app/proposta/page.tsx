...
const MODULES = [
  {
    ...
    entrega:
      "Painel diário com semáforo verde/amarelo/vermelho. Threshold confirmado a 3 km. Aprovação em lote das verdes com um clique. Exportação CSV para PHC Advanced.",
    semanas: "2–3",
  ...
  },
  {
    ...
    entrega:
      "Recepção do PDF, extracção automática, classificação por NIF, validação humana e exportação XML PHC Advanced. Cada correcção cria regra de fornecedor que aplica em próximas facturas. 9 facturas reais já carregadas.",
    semanas: "4–6",
  ...
  },
  {
    ...
    entrega:
      "Aplicação móvel que funciona sem rede. O mecânico regista a intervenção em menos de 3 minutos, com estados iniciar / pausar / aguardar peças / retomar / fechar, tempo activo contabilizado, assinatura no ecrã e validação administrativa antes da exportação PHC Advanced.",
    semanas: "5–8",
    dependencias: "Piloto com 1 mecânico antes de alargar (adopção é risco #1) · folha actual em papel · rede na oficina",
    tier: "Incluído no pacote 5+1",
    invest: "€ 9.000",
  },
];
...
const INVESTMENT_BREAKDOWN = [
  ...
  { label: "Módulo B", detail: "OCR facturas fornecedor + classificação + exportação PHC Advanced", amount: "€ 11.500" },
...
const PHASED_OPTIONS = [
  {
    ...
    bullets: ["Primeiro ganho visível.", "Resolve controlo documental e quilómetros.", "Abre a porta para OCR quando houver confiança."],
...
const TIERS = [
  {
    ...
    includes: [
      ...
      "Pagamento 30 / 40 / 30",
      "Responsável PHC Advanced interno como parceiro técnico",
  ...
  },
  {
    ...
    includes: [
      "Sessão de trabalho com o responsável PHC Advanced interno",
...
const TIMELINE = [
  { week: "1", phase: "Sprint 0", tasks: "Responsável PHC Advanced interno · validação Frotcom/Logue Trans · plano fechado", color: "bg-[hsl(220_9%_45%)]" },
  { week: "2–3", phase: "Módulo A · Validação km", tasks: "Reconciliação Logue Trans × Frotcom · painel · primeira validação interna", color: "bg-[hsl(222_72%_38%)]" },
...
const DEPENDENCIES = [
  {
    ...
    bloqueia: "Módulos A e C em operação ligada aos sistemas",
    mitigacao: "Conectores preparados até a API chegar · reunião técnica de 45 min nas primeiras 72h",
  },
  {
    label: "Responsável PHC Advanced interno",
    owner: "Departamento interno do grupo",
    bloqueia: "Escrita automática nos módulos B, E e F",
    mitigacao: "A plataforma opera com exportação XML enquanto o formato de escrita não fica validado internamente",
  },
  {
    label: "API Frotcom de leitura",
    owner: "Administração grupo",
    bloqueia: "Precisão do módulo D",
    mitigacao: "Enquanto não houver leitura directa, o módulo D sinaliza com abastecimentos reais e odómetro disponível",
  },
  {
  ...
  {
    label: "Piloto mecânico do módulo F",
...
const ROI_MODULES = [
  {
    code: "A",
    title: "Validação km",
    evidence: "160 viagens no cenário operacional · 126 verdes · 23 amarelas · 11 vermelhas · threshold 3 km",
    ...
    <main className="relative min-h-screen bg-[hsl(40_24%_98%)] text-[hsl(220_28%_10%)] overflow-hidden print:bg-white">
      ...
      <section className="relative z-10 mx-auto max-w-[1100px] px-6 lg:px-10 pt-16 pb-10 animate-fade-in">
        ...
        <h1 className="font-display text-5xl lg:text-6xl font-semibold leading-[0.98] tracking-normal max-w-[900px]">
          ...
          <br />
          Plataforma primeiro. <span className="italic">Decisão por fases.</span>
        </h1>
        ...
        <div className="rounded-2xl border border-[hsl(222_72%_30%)]/20 bg-white shadow-elevated-sm p-8 lg:p-10">
          ...
          <div className="grid lg:grid-cols-12 gap-6 lg:gap-10">
            <div className="lg:col-span-8 space-y-4 text-[15px] leading-relaxed">
              ...
              <p>
                <strong>O estado actual é uma plataforma navegável</strong> em
                <code className="font-mono text-[13px] bg-secondary px-1.5 py-0.5 rounded mx-1">
                  lloretrans.aitipro.com
                </code>
                com dados reais carregados e dados de apoio controlados, incluindo as <strong>9 facturas reais</strong> de fornecedores
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3 pt-6 border-t border-[hsl(220_14%_90%)]">
            ...
            <Button asChild size="lg" variant="outline">
              <Link href="mailto:bilal.machraa@aitipro.com?subject=Marcar%20demonstra%C3%A7%C3%A3o%20Lloretrans%20%2B%20proposta">
                Marcar demonstração com proposta
              </Link>
            </Button>
      ...
      <Section
        ...
        intro="A proposta não promete uma poupança artificial. Mostra o limiar que tem de provar, os dados reais já carregados e o controlo novo que cada módulo traz."
      >
        ...
        <div className="mt-8 rounded-xl border border-[hsl(220_14%_88%)] bg-white overflow-x-auto">
          <table className="min-w-[980px] w-full text-sm">
            <thead className="bg-[hsl(40_30%_96%)]">
              <tr>
                <th className="text-left px-5 py-3 text-[11px] uppercase tracking-wider text-muted-foreground font-semibold">Módulo</th>
      ...
      <Section id="contexto" eyebrow="Contexto" title="Seis fluxos. Uma mesma frase-âncora.">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-7 space-y-4 text-[15px] leading-relaxed">
            ...
            <p>
              Mapeámos os seis fluxos discutidos, atribuímos um módulo a cada um e construímos uma
              plataforma navegável em que a Clarice e os decisores do grupo podem ver o funcionamento
              — sem formulários, sem instalação, apenas um URL e perfis pré-configurados.
            </p>
            <p>
              Esta proposta formaliza o âmbito, o investimento e o calendário: plataforma funcional primeiro,
              decisão por fases depois, pacote recomendado de €45.000 quando a administração quiser a
              resposta completa, e módulo D apenas quando a Frotcom estiver confirmada.
            </p>
          </div>
                ...
                <div className="grid lg:grid-cols-12 gap-6 lg:gap-10">
                  ...
                  <div className="lg:col-span-9 space-y-4 text-sm">
                    ...
                    <div className="pt-2">
                      ...
                      >
                        Abrir módulo na plataforma <ArrowUpRight className="h-3.5 w-3.5" />
                      </Link>
                    </div>
                  </div>
                </div>
      ...
      >
        ...
        <div className="mt-8 text-sm text-muted-foreground text-center">
          A mensalidade inclui operação contínua: base de dados Postgres em Frankfurt · servidor aplicacional na União Europeia · registo de auditoria inviolável ·
          exportação XML PHC Advanced · suporte em horário útil · 8h técnicas/mês · IA até 5.000 documentos/mês.
        </div>
        ...
        <div className="mt-6 rounded-xl border border-[hsl(220_14%_88%)] bg-[hsl(40_30%_96%)] p-6 lg:p-7">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="text-xs text-muted-foreground max-w-sm sm:text-right">
              Isto resolve a objecção de credibilidade: podem validar ganhos concretos antes de financiar o módulo seguinte.
            </div>
          </div>
      ...
      <Section
        ...
        intro="Sequenciado por dependência, não por ordem alfabética. A arranca cedo porque dá ganho visível; C prepara B e F; E e F fecham o pacote. D fica fora do preço inicial até a Frotcom confirmar acesso técnico."
      >
        <div
      ...
      >
        <div className="space-y-4">
          <OpenQuestion
            ...
            body="Na reunião a Clarice referiu: «ao domingo não temos ninguém». A plataforma recupera horas, mas a Sprint 0 deve confirmar se os módulos A e D correm sem supervisão nessas janelas, com alertas por e-mail para ocorrências fora-de-padrão, ou se o processo fica estritamente em horário útil."
          ...
          <OpenQuestion
            ...
            title="Plano de adopção do mecânico (módulo F)"
            body="A Clarice levantou a objecção: «mecânicos com 50 anos, vai dar computador, não é com ninguém, papel». Plano proposto: 1 dia de treino presencial com 1 mecânico piloto, 2 semanas de acompanhamento no terreno e plano de contingência em papel com ligação posterior à folha digital. A adopção é indicador formal do piloto F, medida durante o arranque e após o primeiro mês de utilização."
          ...
          <OpenQuestion
            ...
            title="Baselines actuais · sessão de observação"
            body="A Clarice disse «ou perdemos muito tempo» sobre cada um dos 6 módulos, mas não há números. 2–3h de sessão de observação com a administrativa da facturação e o Éder medem o ponto de partida. Sem baseline, o ROI é indicativo, não argumento defensável à administração."
      ...
      <Section id="compliance" eyebrow="Compliance" title="RGPD por defeito. Sem ressalvas.">
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          <ComplianceCard
            ...
            body="Base de dados Postgres em Frankfurt e servidor aplicacional na União Europeia para dados operacionais. Claude/Anthropic só entra com acordo de tratamento de dados aprovado ou fica desligado por fluxo. Retenção configurável por tipo de documento."
          />
          <ComplianceCard
            title="Auditoria imutável"
            body="Cada alteração relevante (aprovar, classificar, transitar) grava utilizador, antes/depois e motivo em registo de auditoria inviolável."
          />
          <ComplianceCard
          ...
          <ComplianceCard
            title="NDA + DPA"
            body="Assinamos NDA antes de qualquer dado real entrar na plataforma. DPA/RGPD formal incluído no pacote Lloretrans 5+1."
          />
        </div>
      </Section>
      ...
      <Section id="proximos-passos" eyebrow="Próximos passos" title="Da demonstração à decisão de investimento.">
        <ol className="space-y-4">
          ...
          <StepItem
            n="2"
            title="Deixar proposta + acesso à plataforma"
            body="Depois da demonstração, enviamos o acesso vivo e a proposta. A conversa passa a ser: que fase aprovar primeiro, que números validar na Sprint 0 e quem tem de estar na decisão."
            when="Após a demonstração"
          />
          <StepItem
            n="3"
          ...
          <div className="relative z-10 grid lg:grid-cols-12 gap-6 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="mt-4 text-white/75 leading-relaxed max-w-2xl">
                O melhor uso desta proposta é em simultâneo com a plataforma aberta. Primeiro validam que a solução corresponde à operação; depois escolhem a fase que faz sentido defender junto da administração.
              </p>
            </div>
            ...
            <div className="lg:text-right">
              ...
              <div className="text-sm space-y-1">
                ...
                <div className="text-muted-foreground text-xs pt-2">
                  Plataforma privada: <Link href="https://lloretrans.aitipro.com" className="inline-flex min-h-11 items-center hover:underline" target="_blank" rel="noopener">lloretrans.aitipro.com</Link>
                </div>
              </div>
            </div>
          </div>
