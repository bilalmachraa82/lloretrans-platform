...
const STYLES: Record<StatusKind, string> = {
  green: "bg-success/12 text-[hsl(152_55%_28%)] border-success/25",
  yellow: "bg-warning/14 text-[hsl(32_82%_30%)] border-warning/30",
  red: "bg-destructive/12 text-[hsl(0_72%_38%)] border-destructive/25",
