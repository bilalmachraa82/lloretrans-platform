...
const serviceCodes = [
  ...
  { code: "S2", label: "Electricista", description: "Reparação eléctrica (veículo cliente)", kind: "oficina_externa", source: "tabela_codigos" },
  ...
  { code: "S6", label: "Electrónica e Programação", description: "Diagnóstico, ECU, programação (veículo cliente)", kind: "oficina_externa", source: "tabela_codigos" },
  { code: "S7", label: "Rectificação e Torneiras", description: "Rectificação mecânica (veículo cliente)", kind: "oficina_externa", source: "tabela_codigos" },
  ...
  { code: "S9", label: "Inspecção", description: "Inspecção IPO (veículo cliente)", kind: "oficina_externa", source: "tabela_codigos" },
  { code: "L1", label: "Serviços de Pneus", description: "Pneus em viatura interna", kind: "oficina_interna", source: "tabela_codigos" },
  { code: "L2", label: "Serviços de Electricista", description: "Eléctrica em viatura interna", kind: "oficina_interna", source: "tabela_codigos" },
  ...
  { code: "L6", label: "Serviços de Rectificação e Torneiras", description: "Rectificação mecânica interna", kind: "oficina_interna", source: "tabela_codigos" },
  { code: "L7", label: "Serviços de Mecânica Geral", description: "Mecânica geral interna", kind: "oficina_interna", source: "tabela_codigos" },
  { code: "L8", label: "Serviços de Electrónica e Programação", description: "Electrónica/programação interna", kind: "oficina_interna", source: "tabela_codigos" },
  ...
  { code: "I7", label: "Serviços de Inspecções", description: "IPO frota interna", kind: "operacao_interna", source: "tabela_codigos" },
